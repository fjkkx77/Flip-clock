# Flip Clock ⏳
> 复古风格的翻页时钟，原生HTML纯前端实现，支持全屏显示、多主题切换，无广告无依赖，适合桌面装饰、直播背景、办公展示。
...
## ✨ 核心功能亮点
- 🎬 **复古翻页动画**：原生CSS3实现经典机械翻页时钟的流畅动画效果，无任何第三方依赖
- 🖥️ **全屏显示模式**：一键切换全屏，适配桌面装饰、直播背景、办公屏保等多种场景
- 🎨 **多主题切换**：内置两款精选主题，一键切换风格，适配不同使用场景
- 📱 **桌面端响应式适配**：电脑完美适配，打开即用
- ⚡ **开箱即用**：纯HTML实现，无需安装配置，下载后直接打开就能用，也可一键部署到自己的GitHub Pages
...
- 翻页动画纯CSS3实现，无任何第三方依赖，加载速度快、兼容性强
